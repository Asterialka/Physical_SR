...
param = {'num_centers': 33,
         'augmentation': False}
directories = {'sampled_data': 'resources/',
               'data': 'data/'}
...
if __name__ == '__main__':
    for cmode in [1, 3]:
        ...
        data_dir = os.path.join(directories['data'], 'sparse_all_data'+train_suffix+'.pkl')
        rgb_data = pickle.load(open(data_dir, 'rb'))['rgb']
        train_rbf_net('./rbf_models/rbf_icvl'+train_suffix+'.pkl', rgb_data, param['num_centers'])
